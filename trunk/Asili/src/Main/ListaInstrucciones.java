    ...
    public void llenarLista(int nivel) {
        switch (nivel) {
            ...
            case 3:
                lista.addElement(new Instruccion(Asili.ANCHO + 30, Asili.ALTO + 30, 2, 2000, 1000));
                lista.addElement(new Instruccion(Asili.ANCHO + 30, Asili.ALTO + 30, 2, 2200, 1000));
                lista.addElement(new Instruccion(Asili.ANCHO + 30, Asili.ALTO + 30, 3, 2400, 500));
                lista.addElement(new Instruccion(Asili.ANCHO + 30, Asili.ALTO + 30, 3, 2500, 1500));
                lista.addElement(new Instruccion(Asili.ANCHO + 30, Asili.ALTO + 30, 3, 2600, 1500));
                lista.addElement(new Instruccion(Asili.ANCHO + 30, Asili.ALTO + 30, 1, 3000, 1000));
                lista.addElement(new Instruccion(Asili.ANCHO + 30, Asili.ALTO + 30, 1, 3100, 1000));
                lista.addElement(new Instruccion(Asili.ANCHO + 30, Asili.ALTO + 30, 3, 3200, 500));
                lista.addElement(new Instruccion(Asili.ANCHO + 30, Asili.ALTO + 30, 1, 3500, 500));
                lista.addElement(new Instruccion(Asili.ANCHO + 30, Asili.ALTO + 30, 1, 4200, 1500));
                lista.addElement(new Instruccion(Asili.ANCHO + 30, Asili.ALTO + 30, 1, 4300, 1000));
                lista.addElement(new Instruccion(Asili.ANCHO + 30, Asili.ALTO + 30, 1, 4500, 1000));
                lista.addElement(new Instruccion(Asili.ANCHO + 30, Asili.ALTO + 30, 2, 4700, 500));
                lista.addElement(new Instruccion(Asili.ANCHO + 30, Asili.ALTO + 30, 3, 4800, 500));
                lista.addElement(new Instruccion(Asili.ANCHO + 30, Asili.ALTO + 30, 1, 4900, 1500));
                lista.addElement(new Instruccion(Asili.ANCHO + 30, Asili.ALTO + 30, 1, 5000, 1000));
                lista.addElement(new Instruccion(Asili.ANCHO + 30, Asili.ALTO + 30, 3, 5200, 1000));
                lista.addElement(new Instruccion(Asili.ANCHO + 30, Asili.ALTO + 30, 3, 5600, 500));
                lista.addElement(new Instruccion(Asili.ANCHO + 30, Asili.ALTO + 30, 3, 5800, 1500));
                lista.addElement(new Instruccion(Asili.ANCHO + 30, Asili.ALTO + 30, 3, 6000, 1500));
